...
@SpringBootTest(
        ...
        properties = {
                ...
                "consuma.financeiro.snapshot-integridade.keys.platform-snapshot-key-v1.status=DISABLED",
...
class SnapshotKeyDisabledIT extends PostgresTestcontainersConfig {
    ...
    void key_disabled_retorna_failureReason_KEY_DISABLED_e_registra_evento() throws Exception {
        ...
        integ.put("signatureKeyId", "platform-snapshot-key-v1");
        ...
        assertThat(json.at("/data/verificacao/assinaturaFailureReason").asText()).isEqualTo("KEY_DISABLED");
