...
public class JwtTokenProvider {
    ...
    public String generateToken(String username, String roles, String instituicaoNome, Long userId, String tokenType) {
        return generateToken(username, roles, instituicaoNome, userId, tokenType, false, false);
    }

    private String generateToken(String username, String roles, String instituicaoNome, Long userId,
                                 String tokenType, boolean mustChangePassword, boolean passwordResetRequired) {
        Date now = new Date();
