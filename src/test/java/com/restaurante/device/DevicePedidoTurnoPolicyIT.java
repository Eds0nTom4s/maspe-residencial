...
@SpringBootTest(
        ...
        properties = {
                ...
                "consuma.operacao.require-open-turno-for-device-orders=false"
        }
)
@AutoConfigureMockMvc(addFilters = false)
@ActiveProfiles("it-postgres")
class DevicePedidoTurnoPolicyIT extends PostgresTestcontainersConfig {
    ...
    void device_canCreatePedido_withoutTurno_when_policy_disabled() throws Exception {
        ...
        assertThat(json.at("/data/pedidoId").asLong()).isPositive();
        assertThat(json.at("/data/turnoOperacionalId").asLong()).isEqualTo(0L);
    }
