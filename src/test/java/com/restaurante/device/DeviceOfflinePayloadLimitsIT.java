...
class DeviceOfflinePayloadLimitsIT extends DeviceAuthIntegrationTestSupport {
    ...
    @Test
    void commandPayloadTooLarge_returns400() throws Exception {
        ProvisionarTenantResponse prov = provisionTenant("offline-payload", "OPL");
        ...
        cmd.setClientRequestId("cmd-big-1");
        ...
        // payload grande (string > 64 bytes)
        cmd.setPayload(objectMapper.readTree("""
                {"activityType":"PING","metadata":{"s":"xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"}}
                """));
        ...
        assertThat(json.at("/code").asText()).isEqualTo("OFFLINE_COMMAND_PAYLOAD_TOO_LARGE");
    }
