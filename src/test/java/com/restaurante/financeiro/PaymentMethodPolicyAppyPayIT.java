...
class PaymentMethodPolicyAppyPayIT extends PostgresTestcontainersConfig {
    ...
    void pos_cannot_start_appypay_when_device_policy_canStartGateway_false() throws Exception {
        ...
        Produto prod = produtoRepository.findByTenantId(prov.getTenantId(), org.springframework.data.domain.PageRequest.of(0, 1))
    ...
    private DispositivoOperacional criarDevicePos(ProvisionarTenantResponse prov) {
        // Reaproveitar um device existente do tenant, se houver; caso contrário criar um mínimo.
