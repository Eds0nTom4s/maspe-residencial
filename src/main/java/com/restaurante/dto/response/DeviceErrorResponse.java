...
public record DeviceErrorResponse(
    ...
    public enum DeviceErrorCode {
        ...
        OFFLINE_BATCH_PAYLOAD_TOO_LARGE,
        OFFLINE_COMMAND_PAYLOAD_TOO_LARGE,
        OFFLINE_TOO_MANY_ITEMS,
        OFFLINE_LOCALREF_NOT_FOUND,
        OFFLINE_LOCALREF_NOT_APPLIED,
        OFFLINE_LOCALREF_TYPE_MISMATCH,
        OFFLINE_LOCALREF_CIRCULAR_DEPENDENCY,
        OFFLINE_LOCALREF_FORWARD_REFERENCE_NOT_ALLOWED,
        OFFLINE_DEPENDENCY_DEPTH_EXCEEDED,
