...
public class BillingEvidencePaymentTest {
    ...
    @Test
    @Transactional
    void billingEvidenceIncluiPaymentsQuandoExistem() {
        Tenant tenant = criarTenant();
        BillingPlan plan = new BillingPlan();
        plan.setCode("PLAN-EVPAY-" + System.nanoTime());
        plan.setName("Plan EvPay");
        ...
        inv.setInvoiceNumber("CONS-BILL-EVPAY-" + System.nanoTime());
        ...
        assertThat(ev.getTotalOutstandingAmount()).isNotNull();
    }

    private Tenant criarTenant() {
        String suffix = String.valueOf(System.nanoTime() % 1_000_000);
        Tenant t = new Tenant();
        t.setNome("Tenant EvPay " + suffix);
        t.setSlug("tenant-evpay-" + suffix);
        t.setTenantCode("TEP" + suffix);
