...
class BusinessProvisioningMetadataMigrationPostgresIT extends PostgresTestcontainersConfig {
    ...
    void migratesV82OperationMetadataAndDoesNotReapplyOnRestart() {
        ...
        try {
            ...
            var migration = flyway(migrationDataSource, MigrationVersion.fromVersion("20260807.01")).migrate();
            ...
            var restart = flyway(migrationDataSource, MigrationVersion.fromVersion("20260807.01")).migrate();
            assertThat(restart.migrationsExecuted).isZero();
            assertThat(jdbc.queryForObject("""
                    select count(*) from flyway_schema_history
                    where version in ('83', '84', '85', '20260722.01', '20260806.01', '20260807.01')
                      and success = true
