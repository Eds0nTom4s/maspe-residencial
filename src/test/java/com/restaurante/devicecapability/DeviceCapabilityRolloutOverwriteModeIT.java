...
class DeviceCapabilityRolloutOverwriteModeIT extends PostgresTestcontainersConfig {
    ...
    void overwrite_only_template_managed_preserves_manual_override() throws Exception {
        ...
        var after = capabilityRepository.findByTenant_IdAndDispositivoOperacional_IdAndCapability(prov.getTenantId(), d.getId(), DeviceCapability.LOOKUP_CONSUMPTION_BY_PHONE)
                .orElseThrow();
    ...
    private DispositivoOperacional criarDevice(ProvisionarTenantResponse prov, OperationalDeviceType opType) {
        ...
        d.setNome("Device Cap OW");
        d.setCodigo("DCOW-" + System.nanoTime());
