...
class DeviceOfflineSyncCapabilitiesIT extends DeviceAuthIntegrationTestSupport {
    ...
    void capabilitiesEndpoint_returnsAllowedCommandsAndServerTime() throws Exception {
        ...
        assertThat(json.at("/data/offlineEnabled").asBoolean()).isTrue();
        assertThat(json.at("/data/allowedCommandTypes").isArray()).isTrue();
        assertThat(json.at("/data/serverTime").asText()).isNotBlank();
        assertThat(json.at("/data/deviceId").asLong()).isEqualTo(disp.getId());
    }
